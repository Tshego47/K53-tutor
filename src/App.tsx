...
const SETS: PracticeSet[] = [
  {
    ...
    detail: 'Mirrors, clutch, stop/yield from 105p PDF.',
    count: 3,
    accent: 'sun',
    questions: [
      { id: 'stop', sign: 'stop', answer: 'Stop', options: ['Stop', 'Yield', 'Speed limit', 'No entry'] },
      { id: 'yield', sign: 'yield', answer: 'Yield', options: ['Yield', 'Stop', 'Roundabout', 'Pedestrian crossing'] },
      { id: 'speed', sign: 'speed', answer: 'Speed limit', options: ['Speed limit', 'Stop', 'Yield', 'No entry'] },
    ],
  },
  {
    id: 'control',
    eyebrow: 'PDF p18-27',
    title: 'Control Signs',
    detail: 'Red cross = no use lane, green arrow = may use.',
    count: 3,
    accent: 'coral',
    questions: [
      { id: 'roundabout', sign: 'roundabout', answer: 'Roundabout', options: ['Roundabout', 'No entry', 'Yield', 'Keep left'] },
      { id: 'light', sign: 'traffic-light', answer: 'Traffic signal', options: ['Traffic signal', 'Stop', 'Yield', 'Speed limit'] },
      { id: 'no-entry', sign: 'no-entry', answer: 'No entry', options: ['No entry', 'Yield', 'Stop', 'Roundabout'] },
    ],
  },
  {
    id: 'warning',
    eyebrow: 'PDF p92-103',
    title: 'Rules of Road',
    detail: 'Towing 3.5m/30km/h, blind spot, bus lanes 6-9am.',
    count: 3,
    accent: 'teal',
    questions: [
      { id: 'stop-2', sign: 'stop', answer: 'Stop', options: ['Stop', 'Yield', 'Speed limit', 'No entry'] },
      { id: 'ped', sign: 'pedestrian', answer: 'Pedestrian crossing', options: ['Pedestrian crossing', 'Stop', 'Yield', 'Speed limit'] },
      { id: 'speed-2', sign: 'speed', answer: 'Speed limit', options: ['Speed limit', 'Yield', 'Stop', 'No entry'] },
    ],
  },
];
